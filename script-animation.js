...
var animData0 = {container: document.getElementById('lottie-1'), renderer: 'svg', loop: false, autoplay: false, path: 'https://gist.githubusercontent.com/vkirzner/d22cac15a02be6478a4b4557f6d1fff7/raw/7f529e1a31c146aeb6304755a669ed1e4b467b5b/4k.bearing.json'};
var animData1 = {container: document.getElementById('lottie-axle-module'), renderer: 'svg', loop: false, autoplay: false, path: 'https://gist.githubusercontent.com/vkirzner/0ab0f8451c6319c0ede1e8b964e980c5/raw/23b14ed8aa62458cbf56e058b655e33e0ff4535c/lottie-axle-module.json'};
var animData2 = {container: document.getElementById('lottie-hub-unite'), renderer: 'svg', loop: false, autoplay: false, path: 'https://gist.githubusercontent.com/vkirzner/b9582b3d41b2f627d2af826e5267e97f/raw/96b9bc562fbc9f6c7f36b675c48c7a1d075e30f0/lottie-hub-unite.json'};
var animData3 = {container: document.getElementById('lottie-trb'), renderer: 'svg', loop: false, autoplay: false, path: 'https://gist.githubusercontent.com/vkirzner/79c99e2427f26ee2eed8e0951f3b608a/raw/1889e646a245f0c403947f8b0a9dd2ce024d5539/lottie-trb.json'};
var animData4 = {container: document.getElementById('lottie-ball'), renderer: 'svg', loop: false, autoplay: false, path: 'https://gist.githubusercontent.com/vkirzner/6861f892638bfe3a1729aed41e40d38e/raw/b7d6fa71328c48f8fdc5b29dd5c90c99f4ff2a09/lottie-ball.json'};
